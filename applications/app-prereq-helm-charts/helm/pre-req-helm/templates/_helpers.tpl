...
{{- define "zookeeperConfigMapName" }}
{{- printf "%s-%s" "zookeeper-envconfig" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{- define "kafkaConfigMapName" }}
{{- printf "%s-%s" "kafka-envconfig" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}
...
{{- define "serviceName" }}
{{- printf "%s-%s" "clusterIp" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end }}
